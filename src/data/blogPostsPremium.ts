...
export const premiumBlogPosts: BlogPost[] = [
  {
    ...
    body: {
      fr: [
        "À Essaouira, le coucher du soleil n'est pas un décor : c'est le personnage principal. Sur le dos d'un cheval, la lumière dorée transforme chaque foulée en image de film. Voici les spots que nos guides choisissent pour des [balades à cheval](/fr/activites/balade-a-cheval-essaouira) inoubliables.",
        ...
        "Consultez nos [tarifs](/fr/tarifs) et la [galerie](/fr/galerie) pour vous projeter avant le départ.",
    ...
    faq: [
      ...
      },
      {
        ...
        answer: {
          fr: "Oui, sur demande depuis le centre d'Essaouira. Précisez-le lors de votre [réservation](/fr/reservation).",
  ...
  },
  {
    ...
    body: {
      fr: [
        ...
        "Dunes, forêt d'arganiers, falaises, plages infinies : la diversité géographique est rare à cette échelle. Nos [excursions quad](/fr/activites/quad-essaouira) exploitent ce relief ; nos [balades à cheval](/fr/activites/balade-a-cheval-essaouira) le subliment au ralenti.",
        "## Le vent comme allié",
        ...
        "Explorez toutes nos [activités Essaouira](/fr/activites) ou [réservez directement](/fr/reservation).",
        "## Questions fréquentes",
      ],
      en: [
        ...
        "Dunes, argan forest, cliffs, endless beaches: geographic diversity is rare at this scale. Our [quad tours](/en/activities/quad-biking-essaouira) use the terrain; our [horse rides](/en/activities/horse-riding-essaouira) elevate it at a slower pace.",
        "## Wind as an ally",
  ...
  },
  {
    ...
    body: {
      fr: [
        ...
        "Notre collection **Shooting & Trek** sur la page [balade à cheval](/fr/activites/balade-a-cheval-essaouira) propose des expériences signature : séance photo à cheval, galop au lever du soleil, treks de 2 à 6 jours.",
        ...
        "Terminez par notre [expérience art-thérapie](/fr/activites/art-experience-essaouira) face à l'océan : mandala, aquarelle, silence. Le contraste est le vrai luxe.",
        "## Où séjourner",
        "Riads de la médina, lodges de Sidi Kaouki, villas avec vue sur l'Atlantique — nous vous conseillons selon votre programme.",
        "Découvrez nos [tarifs premium](/fr/tarifs) et [réservez votre expérience](/fr/reservation).",
        "## Questions fréquentes",
      ],
      en: [
  ...
  },
  {
    ...
    body: {
      fr: [
        ...
        "Notre expérience la plus demandée par les couples. Galoper côte à côte sur Diabat quand le ciel brûle — [réserver une balade](/fr/activites/balade-a-cheval-essaouira).",
        "## 2. Dromadaire privé dans les dunes",
        "Plus lent, plus contemplatif. Idéal pour une demande en mariage ou un anniversaire. [Balade dromadaire](/fr/activites/balade-dromadaire-essaouira) au crépuscule.",
        "## 3. Atelier art à deux",
        "Créez ensemble face à l'Atlantique. [Art experience](/fr/activites/art-experience-essaouira) : mandala, couleurs, silence partagé.",
        "## 4. Quad en duo",
        "Pour les couples aventuriers : sensations fortes, paysages sauvages. [Quad Essaouira](/fr/activites/quad-essaouira).",
        "Voir la [galerie](/fr/galerie) pour vous inspirer, puis [contactez-nous](/fr/contact) pour un programme sur mesure.",
        "## Questions fréquentes",
      ],
      en: [
        ...
        "## 4. Quad as a duo",
        "For adventurous couples: thrills, wild landscapes. [Quad Essaouira](/en/activities/quad-biking-essaouira).",
  ...
  },
  {
    ...
    body: {
      fr: [
        ...
        "Casque, briefing sécurité, eau. Pour réserver : [activité cheval](/fr/activites/balade-a-cheval-essaouira) ou [booking](/fr/reservation).",
        "## Questions fréquentes",
      ],
      en: [
  ...
  },
  {
    ...
    body: {
      fr: [
        ...
        "Lumière douce, vent modéré. Parfait pour [balade à cheval](/fr/activites/balade-a-cheval-essaouira) et [dromadaire](/fr/activites/balade-dromadaire-essaouira). Réservez les sunsets à l'avance.",
        "## Été (juin–août)",
        ...
        "Consultez le [blog](/fr/blog) et nos [tarifs](/fr/tarifs) pour planifier.",
        "## Questions fréquentes",
      ],
      en: [
  ...
  },
  {
    ...
    body: {
      fr: [
        ...
        "Village bohème, ruines de palace, plage infinie. Départ de nos [balades à cheval](/fr/activites/balade-a-cheval-essaouira).",
        ...
        "Dunes, falaises, grottes. Accessible en [quad](/fr/activites/quad-essaouira) ou 4x4. Peu de monde hors saison.",
        "## La côte nord vers Moulay",
        "Longues plages ventées, parfaites pour une promenade après la médina.",
        "Photos : [galerie](/fr/galerie). Réservation : [activités](/fr/activites).",
        "## Questions fréquentes",
      ],
      en: [
        ...
        "Dunes, cliffs, caves. Reachable by [quad](/en/activities/quad-biking-essaouira) or 4x4. Few people off-season.",
  ...
  },
  {
    ...
    body: {
      fr: [
        ...
        "Notre [excursion quad](/fr/activites/quad-essaouira) : forêt d'arganiers, dunes, pistes avec vue océan. Adrénaline garantie.",
        "## Fin de journée : cheval au sunset",
        "Le moment magique. [Balade à cheval](/fr/activites/balade-a-cheval-essaouira) sur Diabat quand le ciel explose. Rien de plus cinématographique.",
        "Réservez le pack via [booking](/fr/reservation) ou WhatsApp depuis notre [contact](/fr/contact).",
        "## Questions fréquentes",
      ],
      en: [
        ...
        "Our [quad tour](/en/activities/quad-biking-essaouira): argan forest, dunes, ocean-view tracks. Guaranteed adrenaline.",
  ...
  },
  {
    ...
    body: {
      fr: [
        ...
        "Pas le Sahara — des dunes basses, mouvantes, face à l'océan. Parfaites pour [cheval](/fr/activites/balade-a-cheval-essaouira) et [dromadaire](/fr/activites/balade-dromadaire-essaouira).",
        "## Lumière de cinéma",
        "Les photographes internationaux viennent ici pour la même raison que nos clients : la qualité de la lumière au golden hour.",
        "## Comment visiter",
        "À pied depuis Essaouira (30 min), taxi, ou directement via nos activités avec transfert. Voir [galerie](/fr/galerie) et [réserver](/fr/reservation).",
        "## Questions fréquentes",
      ],
      en: [
  ...
  },
  {
    ...
    body: {
      fr: [
        ...
        "Découvrez nos forfaits sur [balade à cheval Essaouira](/fr/activites/balade-a-cheval-essaouira) — dont Shooting & Trek premium.",
        "## Réserver",
        "[Tarifs](/fr/tarifs), [booking en ligne](/fr/reservation), [blog](/fr/blog) pour aller plus loin.",
        "## Questions fréquentes",
      ],
      en: [
  ...
  {
    slug: {
      fr: "un-jour-a-essaouira-itineraire",
      en: "one-day-in-essaouira-itinerary",
    },
    title: {
      fr: "Un jour à Essaouira : itinéraire idéal (activités + médina)",
      en: "One Day in Essaouira: Ideal Itinerary (Activities + Medina)",
    },
    excerpt: {
      fr: "Comment organiser une journée complète à Essaouira : matin en quad ou cheval, après-midi médina, sunset dromadaire — planning réaliste.",
      en: "How to plan a full day in Essaouira: morning quad or horse ride, afternoon medina, sunset camel — a realistic schedule.",
    },
    cover: IMG.thingsToDo,
    coverAlt: {
      fr: "Itinéraire d'une journée d'activités à Essaouira",
      en: "One-day activity itinerary in Essaouira",
    },
    ...
    body: {
      fr: [
        "Vous n'avez qu'**une journée à Essaouira** ? Voici un itinéraire réaliste, testé avec nos clients, qui combine outdoor et médina sans tout bâcler.",
        "## Matin (9h–12h) — une activité outdoor",
        "Deux options selon votre énergie :",
        "**Option adrénaline** — [Circuit quad Diabat ou Cap Sim](/fr/activites/quad-essaouira) (1h ou 2h). Départ depuis Diabat, transfert hôtel possible. Idéal si vous voulez du sable, de la forêt d'arganiers et des vues océan.",
        "**Option douce / famille** — [Balade à cheval](/fr/activites/balade-a-cheval-essaouira) d'1h sur la plage de Diabat. Chevaux calmes, dès 6 ans accompagnés.",
        "## Midi — pause médina ou port",
        "Retour vers Essaouira (ex-Mogador). Déjeuner de poisson au port ou tajine dans la médina. Gardez 1h30–2h pour marcher sans stress.",
        "## Après-midi (15h–17h) — médina & remparts",
        "Skala de la ville, ruelles blanches et bleues, artisans du thuya. Pas besoin de guide payant : flânez, achetez du thé, évitez les heures de pointe des bus tours.",
        "## Fin de journée — sunset signature",
        "Le moment le plus photographié : une [balade dromadaire au coucher du soleil](/fr/activites/balade-dromadaire-essaouira) sur Diabat. Dès 4 ans, rythme lent, face à l'Atlantique.",
        "Alternative couples : [cheval sunset 1h ou 2h](/fr/activites/balade-a-cheval-essaouira).",
        "## Soirée",
        "Dîner roof-top ou retour détente. Si vous voulez calmer le rythme après l'aventure, notre [art experience](/fr/activites/art-experience-essaouira) face à l'océan fonctionne très bien en fin d'après-midi.",
        "## Réservation",
        "Pour enchaîner deux activités le même jour, réservez à l'avance via notre [page réservation](/fr/reservation) ou WhatsApp — nous synchronisons les horaires et le transfert.",
        "Voir aussi toutes nos [activités à Essaouira](/fr/activites).",
      ],
      en: [
        "Only **one day in Essaouira**? Here's a realistic itinerary we use with guests — outdoor time plus medina, without rushing everything.",
        "## Morning (9am–12pm) — one outdoor activity",
        "Two options depending on your energy:",
        "**Thrill option** — [Diabat or Cap Sim quad circuit](/en/activities/quad-biking-essaouira) (1h or 2h). Departure from Diabat, hotel pick-up available. Sand, argan forest and ocean views.",
        "**Gentle / family option** — [1-hour horse ride](/en/activities/horse-riding-essaouira) on Diabat beach. Calm horses, from age 6 accompanied.",
        "## Midday — medina or port break",
        "Back to Essaouira (formerly Mogador). Fish lunch at the port or tajine in the medina. Keep 1.5–2 hours to walk without stress.",
        "## Afternoon (3–5pm) — medina & ramparts",
        "Skala, white-and-blue alleys, thuya wood workshops. No paid guide required — wander, drink tea, avoid peak tour-bus hours.",
        "## Late day — signature sunset",
        "The most photographed moment: a [sunset camel ride](/en/activities/camel-ride-essaouira) on Diabat. From age 4, slow pace, facing the Atlantic.",
        "Couples alternative: [sunset horse ride 1h or 2h](/en/activities/horse-riding-essaouira).",
        "## Evening",
        "Rooftop dinner or rest. To wind down after adventure, our [art experience](/en/activities/art-experience-essaouira) by the ocean works well late afternoon.",
        "## Booking",
        "To stack two activities the same day, book ahead via our [booking page](/en/booking) or WhatsApp — we sync timings and transfers.",
        "See also all our [Essaouira activities](/en/activities).",
      ],
    },
    seo: {
      description: {
        fr: "Itinéraire d'un jour à Essaouira : quad ou cheval le matin, médina l'après-midi, dromadaire au sunset. Planning réaliste avec liens réservation.",
        en: "One-day Essaouira itinerary: morning quad or horse, afternoon medina, sunset camel. Realistic schedule with booking links.",
      },
      keywords: {
        fr: [
          "un jour à essaouira",
          "itineraire essaouira 1 jour",
          "que faire à essaouira en un jour",
          "activités essaouira",
        ],
        en: [
          "one day in essaouira",
          "essaouira one day itinerary",
          "things to do in essaouira in one day",
  ...
  {
    slug: {
      fr: "meilleures-activites-outdoor-essaouira",
      en: "best-outdoor-activities-essaouira",
    },
    title: {
      fr: "Meilleures activités outdoor à Essaouira : cheval, quad ou dromadaire ?",
      en: "Best Outdoor Activities in Essaouira: Horse, Quad or Camel?",
    },
    excerpt: {
      fr: "Comparatif clair pour choisir entre balade à cheval, quad et dromadaire à Essaouira — selon âge, budget, durée et ambiance.",
      en: "A clear comparison to choose horse riding, quad or camel in Essaouira — by age, budget, duration and vibe.",
    },
    cover: IMG.beachAdventures,
    coverAlt: {
      fr: "Activités outdoor à Essaouira — cheval, quad, dromadaire",
      en: "Outdoor activities in Essaouira — horse, quad, camel",
    },
    category: { fr: "Guide", en: "Guide" },
    ...
    body: {
      fr: [
        "Cherchez-vous les **meilleures activités outdoor à Essaouira** ? Voici comment choisir entre nos trois expériences phares — sans jargon marketing.",
        "## Balade à cheval — pour la lumière et le rythme",
        "Sur la plage de Diabat, au coucher du soleil surtout. Dès 6 ans, tous niveaux. [Voir la balade à cheval](/fr/activites/balade-a-cheval-essaouira) — dès 20€.",
        "**Idéal si** : vous voulez des photos cinématographiques, une ambiance douce, ou un sunset en couple.",
        "## Quad — pour l'aventure et les circuits",
        "Dunes, forêt d'arganiers, Cap Sim, parfois grotte ou cascade. Dès 16 ans au guidon, 12 ans en passager. [Voir les circuits quad](/fr/activites/quad-essaouira) — dès 30€.",
        "**Idéal si** : vous voulez de l'adrénaline et voir plusieurs paysages en peu de temps.",
        "## Dromadaire — pour la douceur et la famille",
        "Caravane face à l'océan, rythme lent, dès 4 ans. [Voir la balade dromadaire](/fr/activites/balade-dromadaire-essaouira) — dès 20€.",
        "**Idéal si** : enfants en bas âge, première expérience Maroc, ou sunset contemplatif.",
        "## Que faire à Essaouira selon votre profil ?",
        "- **Famille** : dromadaire + cheval court, ou quad en passager.",
        "- **Couples** : cheval sunset ou dromadaire sunset.",
        "- **Amis / adrénaline** : Cap Sim 2h en quad.",
        "- **Une journée complète** : suivez notre [itinéraire 1 jour](/fr/blog/un-jour-a-essaouira-itineraire).",
        "## Où ça se passe ?",
        "La plupart des départs sont à **Diabat**, à quelques minutes d'Essaouira (Mogador). Transfert hôtel gratuit depuis le centre.",
        "## Réserver",
        "Comparez les [tarifs](/fr/tarifs) ou [réservez en ligne](/fr/reservation). Toutes les [activités Essaouira](/fr/activites) sur une seule page.",
      ],
      en: [
        "Looking for the **best outdoor activities in Essaouira**? Here's how to choose between our three signature experiences — without the fluff.",
        "## Horse riding — for light and pace",
        "On Diabat beach, especially at sunset. From age 6, all levels. [See horse riding](/en/activities/horse-riding-essaouira) — from €20.",
        "**Best if**: you want cinematic photos, a gentle vibe, or a couple's sunset.",
        "## Quad — for adventure and circuits",
        "Dunes, argan forest, Cap Sim, sometimes cave or waterfall. From 16 to ride, 12 as passenger. [See quad tours](/en/activities/quad-biking-essaouira) — from €30.",
        "**Best if**: you want adrenaline and multiple landscapes in little time.",
        "## Camel — for calm and families",
        "Caravan facing the ocean, slow pace, from age 4. [See camel ride](/en/activities/camel-ride-essaouira) — from €20.",
        "**Best if**: young kids, first Morocco experience, or a contemplative sunset.",
        "## What to do in Essaouira by traveler type?",
        "- **Family**: camel + short horse ride, or quad as passenger.",
        "- **Couples**: sunset horse or sunset camel.",
        "- **Friends / thrills**: Cap Sim 2h quad.",
        "- **Full day**: follow our [one-day itinerary](/en/blog/one-day-in-essaouira-itinerary).",
        "## Where does it start?",
        "Most departures are in **Diabat**, minutes from Essaouira (Mogador). Free hotel pick-up from the center.",
        "## Book",
        "Compare [prices](/en/prices) or [book online](/en/booking). All [Essaouira activities](/en/activities) on one page.",
      ],
    },
    seo: {
      description: {
        fr: "Cheval, quad ou dromadaire à Essaouira ? Comparatif des meilleures activités outdoor : âge, prix, durée, Diabat, sunset.",
        en: "Horse, quad or camel in Essaouira? Compare the best outdoor activities: age, price, duration, Diabat, sunset.",
      },
      keywords: {
        fr: [
          "meilleures activités outdoor essaouira",
          "activités essaouira",
          "que faire à essaouira",
          "quad ou cheval essaouira",
        ],
        en: [
          "best outdoor activities essaouira",
